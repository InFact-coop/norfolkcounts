...
function facebook_link()
{
  ...
  return( "https://facebook.com/sharer.php?u=" . urlencode( get_permalink($frontpage_id) ) );
...
function twitter_link()
{
  ...
  $frontpage_id = get_option( 'page_on_front' );
  $meta_desc = get_post_meta($frontpage_id, '_yoast_wpseo_twitter-description', true);
  return( "https://twitter.com/intent/tweet?url=" . urlencode( get_permalink($frontpage_id) ) ."&text=" . urlencode( $meta_desc ) );
...
function tweet_this($text)
{
  ...
  return( "https://twitter.com/intent/tweet?url=" . urlencode( get_permalink() ) ."&text=" . urlencode( strip_tags($text) ) );
...
if(false):
  ...
  */
  ...
  add_filter( 'the_seo_framework_description_output', '_3tone_custom_ogdesc_tags', 10, 2 );
  add_filter( 'the_seo_framework_ogdescription_output', '_3tone_custom_ogdesc_tags', 10, 2 );
  add_filter( 'the_seo_framework_twitterdescription_output', '_3tone_custom_ogdesc_tags', 10, 2 );
  ...
  add_filter( 'the_seo_framework_ogtitle_output', '_3tone_custom_ogtitle_tags', 10, 2 );
  add_filter( 'the_seo_framework_twittertitle_output', '_3tone_custom_ogtitle_tags', 10, 2 );
  ...
  add_filter( 'the_seo_framework_ogimage_output', '_3tone_custom_ogimage_tags', 10, 2 );
  add_filter( 'the_seo_framework_twitterimage_output', '_3tone_custom_ogimage_tags', 10, 2 );
  ...
  add_filter( 'the_seo_framework_rel_canonical_output', '_3tone_custom_canonical_tags', 10, 2 );
  add_filter( 'the_seo_framework_ogurl_output', '_3tone_custom_canonical_tags', 10, 2 );
