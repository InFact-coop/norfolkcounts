...
<div <?php acf_esc_attr_e($div); ?>>
   ...
   'value' => $field['value']
	...
	<div class="show-if-value image-wrap" <?php if (
   $size['width']
  ...
  'Edit',
  'acf'
); ?>"></a><?php endif; ?><a class="acf-icon -cancel dark" data-name="remove" href="#" title="<?php _e('Remove', 'acf'); ?>"></a>
		</div>
	</div>
        ...
        foreach ($meta['sizes'] as $k => $v) {
          if (!isset($response['sizes'][$k])) {
            $response['sizes'][$k] = array(
              ...
              'url' => $base_url . $v['file'],
              'orientation' =>
                $v['height'] > $v['width'] ? 'portrait' : 'landscape'
            );
          }
        }
      }
