  ...
  class acf_field_wysiwyg extends acf_field
  {
    ...
    function add_filters()
    {
      ...
      if (!empty($GLOBALS['wp_embed'])) {
        add_filter(
          'acf_the_content',
          array($GLOBALS['wp_embed'], 'run_shortcode'),
          8
        );
        add_filter(
          'acf_the_content',
    ...
    function get_toolbars()
    {
      ...
      if (acf_version_compare('wp', '<', '3.9')) {
        ...
        $teeny_mce_buttons =
          'bold, italic, underline, blockquote, strikethrough, bullist, numlist, justifyleft, justifycenter, justifyright, undo, redo, link, unlink, fullscreen';
...
<?php
    ...
    function render_field($field)
    {
      ...
      if (acf_version_compare('wp', '>=', '4.3')) {
        ...
        $function =
          $default_editor === 'html' ? 'wp_htmledit_pre' : 'wp_richedit_pre';
   ...
   'acf'
    ...
    function render_field_settings($field)
    {
      ...
      acf_render_field_setting($field, array(
        ...
        'instructions' => __(
          'TinyMCE will not be initalized until field is clicked',
          'acf'
        ),
        'name' => 'delay',
        'type' => 'true_false',
