...
if (!class_exists('acf_field_oembed')):
  class acf_field_oembed extends acf_field
  {
    ...
    function initialize()
    {
      ...
      // extra
      add_action('wp_ajax_acf/fields/oembed/search', array(
        $this,
        'ajax_query'
      ));
      add_action('wp_ajax_nopriv_acf/fields/oembed/search', array(
        $this,
        'ajax_query'
      ));
    }
   ...
   'data-name' => 'value-input'
	...
	<div class="title">
		...
		<div class="title-search">
			<input data-name="search-input" type="text" placeholder="<?php _e(
     "Enter URL",
     'acf'
   ); ?>" autocomplete="off" />
		</div>
	...
	<div class="canvas">
     ...
     "Error.",
     'acf'
   ); ?></strong> <?php _e("No embed found for the given URL.", 'acf'); ?></p>
		</div>
