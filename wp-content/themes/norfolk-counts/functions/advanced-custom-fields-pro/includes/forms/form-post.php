  ...
  class ACF_Form_Post
  {
    ...
    function __construct()
    {
      ...
      add_filter(
        ...
        array($this, 'wp_insert_post_empty_content'),
        10,
        2
      );
      ...
      // ajax
      add_action('wp_ajax_acf/post/get_field_groups', array(
        $this,
        'get_field_groups'
      ));
    }
    ...
    function admin_head()
    {
      ...
      if (!empty($field_groups)) {
        foreach ($field_groups as $i => $field_group) {
          ...
          // visibility
          $args['visibility'] = acf_get_field_group_visibility(
            $field_group,
            array(
...
<?php
    ...
    function allow_save_post($post)
    {
      ...
      if ($post->post_type == 'revision') {
        ...
        if ($form_post_id && $form_post_id !== $post->post_parent) {
          $allow = false;
        }
      }
