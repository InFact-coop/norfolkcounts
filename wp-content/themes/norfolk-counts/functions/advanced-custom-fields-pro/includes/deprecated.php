  ...
  class acf_deprecated
  {
    ...
    function __construct()
    {
      ...
      add_filter(
        ...
        array($this, 'acf_settings_l10n_textdomain'),
        5,
        1
      ); // 5.3.3
      add_filter(
        'acf/settings/l10n_field',
        array($this, 'acf_settings_l10n_field'),
        5,
        1
      ); // 5.3.3
      add_filter(
      ...
      add_filter(
        ...
        array($this, 'acf_validate_setting'),
        5,
        1
      ); // 5.6.8
      ...
      add_filter(
        'acf/validate_field',
        array($this, 'acf_validate_field'),
        10,
        1
      ); // 5.5.6
      add_filter(
        'acf/validate_field_group',
        array($this, 'acf_validate_field_group'),
        10,
        1
      ); // 5.5.6
      add_filter(
        'acf/validate_post_id',
        array($this, 'acf_validate_post_id'),
        10,
        2
      ); // 5.5.6
    }
    ...
    function acf_validate_field($field)
    {
      ...
      $field = apply_filters(
        "acf/get_valid_field/type={$field['type']}",
        $field
      );
