...
class acf_wpml_compatibility
{
  ...
  function __construct()
  {
    ...
    add_action(
      'acf/input/form_data',
      array($this, 'acf_input_form_data'),
      10,
      1
    );

    // always prevent 'acf-field' from being translated
    add_filter('get_translatable_documents', array(
      $this,
    ...
    add_action(
      'acf/update_500_field_group',
      array($this, 'update_500_field_group'),
      10,
      2
    );
    add_action(
  ...
  function update_field_group($field_group)
  {
    ...
    $this->lang = $sitepress->get_language_for_element(
      $field_group['ID'],
      'post_acf-field-group'
    );
  }
