...
class acf_media
{
  ...
  function __construct()
  {
    ...
    add_filter(
      ...
      array($this, 'acf_input_admin_l10n'),
      10,
      1
    );
    ...
    add_action(
      ...
      array($this, 'wp_ajax_query_attachments'),
      -1
    );
  }
  ...
  function handle_upload_prefilter($file)
  {
    ...
    $errors = apply_filters(
      "acf/upload_prefilter/name={$field['name']}",
      $errors,
      $file,
      $field
    );
...
<script type="text/javascript">
	if( acf ) acf.media.mime_types = <?php echo json_encode(
