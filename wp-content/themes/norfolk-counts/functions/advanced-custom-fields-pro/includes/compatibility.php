...
class acf_compatibility
{
  ...
  function __construct()
  {
    ...
    add_filter(
      ...
      array($this, 'validate_relationship_field'),
      20,
      1
    );
    add_filter(
    ...
    add_filter(
      ...
      array($this, 'validate_image_field'),
      20,
      1
    );
    add_filter(
    ...
    add_filter(
      ...
      array($this, 'validate_wysiwyg_field'),
      20,
      1
    );
    add_filter(
      'acf/validate_field/type=date_picker',
      array($this, 'validate_date_picker_field'),
      20,
      1
    );
    add_filter(
      'acf/validate_field/type=taxonomy',
      array($this, 'validate_taxonomy_field'),
      20,
      1
    );
    add_filter(
      'acf/validate_field/type=date_time_picker',
      array($this, 'validate_date_time_picker_field'),
      20,
      1
    );
    add_filter(
    ...
    add_filter(
      ...
      array($this, 'validate_field_group'),
      20,
      1
    );
  }
  ...
  function validate_field_group($field_group)
  {
    ...
    if (empty($field_group['key'])) {
      ...
      // add missing key
      $field_group['key'] = empty($field_group['id'])
        ? uniqid('group_')
