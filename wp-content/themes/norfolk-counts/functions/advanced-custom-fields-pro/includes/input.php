...
function acf_enqueue_uploader()
{
  ...
  // create dummy editor
  ?><div id="acf-hidden-wp-editor" class="acf-hidden"><?php wp_editor(
  '',
  'acf_content'
); ?></div><?php
}
...
function acf_form_data($args = array())
{
  ...
  ?>
	<div id="acf-form-data" class="acf-hidden">
		...
		<input type="hidden" id="_acf_<?php echo esc_attr(
    $k
  ); ?>" name="_acf_<?php echo esc_attr($k); ?>" value="<?php echo esc_attr(
  $v
); ?>" />
		<?php endforeach; ?>
