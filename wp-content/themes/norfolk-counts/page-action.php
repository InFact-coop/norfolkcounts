  ...
  <div class="row">
    ...
    <div class="small-12 medium-4 columns text-center action-highlight">
      <p>
        Norfolk protected
        <span>475</span>
        girls from non-consensual marriages.
      </p>
    </div>
    <div class="small-12 medium-4 columns text-center action-highlight">
      <p>
        Norfolk ensured
        <span>632</span>
        new mothers in Bangladesh receive proper maternal healthcare.
      </p>
    </div>
    <div class="small-12 medium-4 columns text-center action-highlight">
      <p>
        Norfolk saved
        <span>48</span>
        children’s lives by funding critical vaccinations.
      </p>
    </div>
    ...
    <div class="small-12 columns text-center">
      <div class="block-content">
        ...
        <p>
          Norfolk counts and so do you. Make your voice heard and protect UK aid
    ...
    <div class="small-12 columns text-center">
      <div class="row">
        <div class="small-6 medium-6 large-3 columns">
          ...
          <a
            href="<?= facebook_link() ?>"
            class="button btn-social facebook"
            target="_blank"
            data-log-ga
