  ...
  <div class="step step-1-no">
    <div class="row">
      <div class="small-12 columns text-center">
        ...
        <p>
          <a href="<?= $fields['step_1']['no_answer_link']['url'] ?>" data-log-ga data-ga-category="metro-link" data-ga-action="click" data-ga-label="Clicked 'reasons to move'" data-link-out="<?= $fields['step_1']['no_answer_link']['url'] ?>" target="_blank"><?= $fields['step_1']['no_answer_link']['title'] ?></a><br />And, if you need yet another reason...
        </p>
...
<section class="landing">
  ...
  <div class="navigation-slider">
    ...
    <div id="slider-nav" class="bullet-slider"></div>
  ...
  <div class="landing-slider">
    <div class="row expanded collapse">
      <div class="small-12 columns">
        <div id="slider" class="header-slider"></div>
      </div>
    </div>
  </div>
  <!-- //Slider -->
